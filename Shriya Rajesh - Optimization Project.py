...
Length = 1 # starting dimension of the length
radius = 1
diameter = radius * 2
...
while (time < 25): # number of dimensions plotted
  ...
  if (coin_amount == square_amount): # if square packing is most efficient
    print("\nDimension:", Length, "  Square Packing is more efficient.")
    square.append(Length)
  elif (coin_amount == hexagon_amount): # if hexagonal packing is most efficient
    print("\nDimension:", Length, "  Hexagonal Packing is more efficient.")
    hexagon.append(Length)
  else: # when modified version of hexagonal packing is most efficient
    print("\nDimension:", Length, "  Modified Hexagonal Packing is more efficient.")
    modified.append(Length)
  ...
  efficiency = (1 - (extra_space/box_area))*100 # maximum efficiency
  efficient.append(efficiency)

  print("\nYou have stored a value of: \t", coin_amount, "coins.")
  print("Your extra space is:  \t\t", extra_space, "square units.")
  print("Your efficiency is:  \t\t", efficiency, "%\n")
  coinsss.append(coin_amount)

  Length += 1
  time += 1

# Summarizes Info
print("Square Packing is efficient for the following dimensions:")
for s in square:
  print(s)
print("Hexagonal Packing is efficient for the following dimensions:")
for h in hexagon:
  print(h)
print("Modified Hexagonal Packing is efficient for the following dimensions:")
for m in modified:
  print(m)
print("\n")
...
print("Number of Coins vs. Percentage of Efficiency")
plt.plot(coinsss, efficient)

print("Dimension Length vs. Percentage of Efficiency")
plt.plot(lengths, efficient)
